...
public class _CampusServerStub extends org.omg.CORBA.portable.ObjectImpl implements CampusServerApp.CampusServer
{
  ...
  public String bookRoom (CampusServerApp.Campus campusName, int roomNumber, CampusServerApp.Date date, CampusServerApp.TimeSlot timeSlot, String id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String createRoom (int roomNumber, CampusServerApp.Date date, CampusServerApp.TimeSlot[] timeSlotSet, String id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
  ...
  public String deleteRoom (int roomNumber, CampusServerApp.Date date, CampusServerApp.TimeSlot[] timeSlotSet, String id)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
